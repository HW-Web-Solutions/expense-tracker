...
- expense_date: date in YYYY-MM-DD format, or null if not visible (string | null)
...
- If the date is not visible, return null for expense_date and set needs_review to true — do not guess today's date
